...
class AjoutMembreForm(forms.Form):
    ...
    peut_gerer_produits = forms.BooleanField(label="Gerer les produits", required=False)
    peut_gerer_stock = forms.BooleanField(label="Gerer le stock", required=False)
    peut_gerer_commandes = forms.BooleanField(label="Gerer les commandes", required=False, initial=True)
    peut_voir_statistiques = forms.BooleanField(label="Voir les statistiques", required=False)
