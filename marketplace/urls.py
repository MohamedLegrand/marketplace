...
admin.site.site_header = "Administration - Jennifer Website"
admin.site.site_title = "Jennifer Website"
admin.site.index_title = "Gestion de la plateforme"

urlpatterns = [
    path("admin/assistant-ia/", include("admin.assistant_ia.urls")),
    ...
    path("vendeur/boutiques/<int:boutique_pk>/caisse/", include("vendeur.caisse.urls")),
    ...
    path("compte/notifications/", include("client.notifications.urls")),
